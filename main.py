...
label_map = {7 : 574, 0: 482, 8:701, 9:0, 6:571, 2:497, 3:217, 1:491, 4:566, 5:569}
#tester
if __name__ == '__main__':
	...
	class ImageDataset(torch.utils.data.Dataset):
		...
		def __getitem__(self, idx):
			thing = self.data[idx].float()
			if self.transform is not None:
				data = self.transform(thing)
			else:
	...
	generated_images, original_labels, running_loss = FGSM.targeted_adversarial_attack(model, dataloader, 1, 10, labels)
	print(running_loss)
	torch.save(generated_images, "../targeted.pt")
	torch.save(original_labels, "../targeted_labels.pt")
